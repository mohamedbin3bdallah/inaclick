          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_lang'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open('langs/editlang/'.$lang->lnid, $attributes);
					?>
					...
					?>
                      ...
                      </div>-->					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('code').' <span class="required">*</span>','code',$data);														$strings = json_decode(file_get_contents('application/language/langs.json'),true);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">							<select name="code" class="form-control col-md-7 col-xs-12">																<?php									foreach($strings as $string)									{										if($string['code'] == $lang->lncode) $selected = 'selected';										else $selected = '';										echo '<option value="'.$string['code'].'" '.$selected.'>'.$string['nativeName'].'</option>';									}								?>															</select>						                        </div>                      </div>					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('dir').' <span class="required">*</span>','dir',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						<?php								$ourtypes = array();								$ourtypes['rtl'] = lang('rtl');								$ourtypes['ltr'] = lang('ltr');								echo form_dropdown('dir', $ourtypes, set_value('dir', $lang->lndir), 'class="form-control"');						?>                        </div>                      </div>
					  <div class="form-group">
                        <?php
							$data = array(
								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							...
							if($lang->lnactive == '1') $data['checked'] = 'TRUE';
