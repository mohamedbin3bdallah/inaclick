<link rel="stylesheet" href="<?php echo base_url(); ?>idea2tech/css/faq-ar.css">

<div class="faq">
    <div class="container">
        <h1 class="head"><?php echo $this->pages['title'.$front_lang][$pageid]; ?></h1>
        <div class="design"></div>
        <div class="text col-md-12 fadeInRight wow" data-wow-duration='1.8s' data-wow-offset="300">
