    ...
    <div class="container">
        ...
        <div class="col-md-3 col-xs-6">
            <ul class="list-unstyled">
                ...
                <?php if(in_array('AB',$this->sections)) { ?><li><a href="<?php echo base_url(); ?>about-en">About us</a></li><?php } ?>
                <?php if(in_array('CG',$this->sections)) { ?><li><a href="<?php echo base_url(); ?>services-en">Services</a></li><?php } ?>
                <?php if(in_array('PR',$this->sections)) { ?><li><a href="<?php echo base_url(); ?>projects-en">Our Projects</a></li><?php } ?>
                <?php if(in_array('OD',$this->sections)) { ?><li><a href="<?php echo base_url(); ?>pay_now-en">Order Now</a></li><?php } ?>
            </ul>
        </div>
        ...
        <div class="col-md-3 col-xs-6">
            <ul class="list-unstyled">
                <li>SUPPORT</li>
                <?php if(in_array('FA',$this->sections)) { ?><li><a href="<?php echo base_url(); ?>faqs-en">FAQ</a></li><?php } ?>
