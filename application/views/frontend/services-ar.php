...
<div class="first ">
    <div class="container">
        ...
        <div class="text col-md-6 fadeInLeft wow" data-wow-duration='1.8s' data-wow-offset="300">
                ...
                <a href="<?php echo base_url(); ?>plans-ar/<?php echo $services[0]->cgid; ?>"><button class="btn button">اطلب الان</button></a>
        </div>
...
<div class="app">
    <div class="container fadeInUp wow " data-wow-duration='1.8s' data-wow-offset="200">
        ...
        <div class="text col-md-6">
            ...
            <a href="<?php echo base_url(); ?>plans-ar/<?php echo $services[1]->cgid; ?>"><button class="btn button">اطلب الان</button></a>
        </div>
...
<div class="mark">
    <div class="container wow fadeInLeft" data-wow-duration='1.8s' data-wow-offset="200">
        ...
        <a href="<?php echo base_url(); ?>plans-ar/<?php echo $services[2]->cgid; ?>"><button class="btn button">اطلب الان</button></a>
    </div>
</div>
...
<div class="desi">
    <div class="container wow " data-wow-duration='1.8s'>
        ...
        <?php	echo htmlspecialchars_decode(stripslashes($services[3]->$service_desc_lang));	?>
            <a href="<?php echo base_url(); ?>plans-ar/<?php echo $services[3]->cgid; ?>"><button class="btn button">اطلب الان</button></a>
    ...
    <div class="container">
       <h1 class="title2"><?php	echo $services[4]->$service_title_lang;	?> <img src="<?php echo base_url().$categories_folder.$services[4]->cgimg; ?>" alt=""></h1>
        ...
        <div class="part col-md-6 wow fadeInRight" data-wow-duration='1.8s' data-wow-offset="200">
            ...
            <a href="<?php echo base_url(); ?>plans-ar/<?php echo $services[4]->cgid; ?>"><button class="btn button">اطلب الان</button></a>
        </div>
    </div>
</div>
